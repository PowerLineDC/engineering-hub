...
function App() {
  ...
  useEffect(() => {
    const savedQuantity = localStorage.getItem(`estimate-rasskazka-${ros301.id}`)
    if (savedQuantity !== null) setQuantity(savedQuantity)
  }, [])
  ...
  const saveQuantity = () => localStorage.setItem(`estimate-rasskazka-${ros301.id}`, quantity)
