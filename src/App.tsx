...
function App() {
  ...
  return (
    <div className="app-container">
      ...
      {isEstimateOpen && <div className="modal-overlay" onClick={closeEstimateModal}><div className="modal-content" onClick={(e) => e.stopPropagation()}><div className="modal-header"><h2 className="modal-title">Смета</h2><button className="modal-close" onClick={closeEstimateModal}>✕</button></div><div className="modal-body"><div className="manufacturer-folders"><button className="manufacturer-folder-button">Рассказовка</button></div></div></div></div>}
