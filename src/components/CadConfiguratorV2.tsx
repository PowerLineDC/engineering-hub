...
function CadConfiguratorV2({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    ...
    const onPointerDown = (e: PointerEvent) => {
      ...
      select(group)
      dragging = true
      dragAxis = e.button === 1 || e.shiftKey ? 'z' : 'xy'
